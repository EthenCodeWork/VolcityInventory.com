...
<div class="bg-gd-dusk">
    <div class="hero-static content content-full bg-white" style="" data-toggle="appear">
        <!-- Header -->
                ...
                <form class="js-validation-signin" action="" method="post">
                    ...
                    <div class="form-group row gutters-tiny">
                        <div class="col-12 mb-10">
                            <button type="submit" name="loginbtn" id="loginbtn" class="btn btn-block btn-hero btn-noborder btn-rounded btn-alt-primary">
                                <i class="si si-login mr-10"></i> Sign In
                            </button>
                        </div>
                        <div class="col-sm-6 mb-5">
                            <a class="btn btn-block btn-noborder btn-rounded btn-alt-secondary" href="register.php">
